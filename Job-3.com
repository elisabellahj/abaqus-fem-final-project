...
options = {
    ...
    'lanczos':OFF,
    'libs':[],
    'listener_name':'AVD-CA-zkrz-0.win.ntnu.no',
    'listener_resource':'20644',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('avd-ca-zkrz-0.win.ntnu.no', 'avd-ca-zkrz-0', '10.99.6.32'),
    'mp_host_list':(('avd-ca-zkrz-0', 2),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l elishje -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
